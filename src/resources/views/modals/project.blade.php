...
{{--           <form  action="{{ route('project-update/'.$project->id) }}"  id="form-people-project-post" method="post">--}}
       ...
       <div class="modal-footer">
         ...
         <button type="submit" name="save_team" form="form-people-project-post" class="btn btn-primary">@{{ typeof project.id !== 'undefined' ? 'Update Project' : 'Create Project' }}</button>
       </div>
     </div>
   </div>
 </div>