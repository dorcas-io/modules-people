...
{{--        </div>--}}
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" v-on:submit.prevent="addDepartmentToProject" action="">
                    ...
                    <fieldset class="form-fieldset">
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <select class="form-control"  v-model="addToProject.department" required>
                                    ...
                                    <option v-for="department in departments"
                                             v-if="addedDepartments.indexOf(department.id) === -1"
                                            :key="department.id"
                                            :value="department.id">
                                            @{{ department.name}}
                                    </option>
                            ...
                            <div class="col-md-6">
                                <button class="btn btn-primary" type="submit" name="action">Add Department To  Project</button>
                            </div>
                        </div>
                    </fieldset>
                </form>
                <div>
                    <p>
                    <div class="tag" v-for="(department, index) in currentDepartmentAssigned" :key="department.id">
                      <strong>@{{ department.name}} </strong>&nbsp;| &nbsp;
                       <a v-bind:href="'/mpe/people-departments/'+department.uuid" target="_blank">View</a>
...
@section('body_js')
    <script type="text/javascript">
        new Vue({
            ...
            created(){
                this.currentDepartmentAssigned = this.project['department']
                this.addedDepartments =  this.project['department'].map(function (e) { return e.id });
            ...
            methods: {
                ...
                removeDepartment: function (e) {
                    ...
                    // console.log(attrs['data-index'])

                    let department = typeof this.departmentsAssignedToProject[index] !== 'undefined' ? this.departmentsAssignedToProject[index]['name'] : null;
                    ...
                    Swal.fire({
                        ...
                        text: "Are you sure you want to remove  "+ this.departmentsAssignedToProject[index]['name'] + " from  " +context.project.name+"?",
                        type: "warning",
                        ...
                        preConfirm: (delete_employee_group) => {
                            ...
                            return axios.post("/mpe/project/department-unassign/" + context.project.id , {
                                department_id: this.departmentsAssignedToProject[index]['uuid']
                              ...
                              context.processing = false;
                                ...
                                return swal("Deleted!", "Department "+ this.departmentsAssignedToProject[index]['name'] +" was successfully removed ", "success");
                            })
                ...
                addDepartmentToProject: function () {
                    ...
                    Swal.fire({
                        ...
                        preConfirm: (add_employee_group) => {
                            this.processing =  true;
                            console.log( context.addToProject.department)
